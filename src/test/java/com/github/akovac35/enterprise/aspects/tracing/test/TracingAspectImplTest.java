...
public class TracingAspectImplTest {
	...
	public void staticInitializorTest() {
		...
		key = "entering com.github.akovac35.enterprise.aspects.tracing.test.CustomCode <clinit>";
		...
		key = "returning com.github.akovac35.enterprise.aspects.tracing.test.CustomCode <clinit>";
		value = TestLogger.getMessages().get(key);
		assertTrue(TestLogger.getMessages()
				.containsKey(key));
		assertTrue("none".equals(value));
	...
	public void constructorTest() {
		...
		key = "entering com.github.akovac35.enterprise.aspects.tracing.test.CustomCode <init>";
		value = TestLogger.getMessages().get(key);
		assertTrue(TestLogger.getMessages()
				.containsKey(key));
		assertTrue("none".equals(value));
		...
		key = "returning com.github.akovac35.enterprise.aspects.tracing.test.CustomCode <init>";
		value = TestLogger.getMessages().get(key);
		assertTrue(TestLogger.getMessages()
				.containsKey(key));
		assertTrue("none".equals(value));
	...
	public void staticMethodCallTest() {
		...
		key = "entering com.github.akovac35.enterprise.aspects.tracing.test.CustomCode doSomethingStatic";
		value = TestLogger.getMessages().get(key);
		assertTrue(TestLogger.getMessages()
				.containsKey(key));
		...
		key = "returning com.github.akovac35.enterprise.aspects.tracing.test.CustomCode doSomethingStatic";
		value = TestLogger.getMessages().get(key);
		assertTrue(TestLogger.getMessages()
				.containsKey(key));
	...
	public void methodCallTest() {
		...
		key = "entering com.github.akovac35.enterprise.aspects.tracing.test.CustomCode doSomething";
		value = TestLogger.getMessages().get(key);
		assertTrue(TestLogger.getMessages()
				.containsKey(key));
		...
		key = "returning com.github.akovac35.enterprise.aspects.tracing.test.CustomCode doSomething";
		value = TestLogger.getMessages().get(key);
		assertTrue(TestLogger.getMessages()
				.containsKey(key));
	...
	public void noTraceTest() {
		...
		key = "entering com.github.akovac35.enterprise.aspects.tracing.test.CustomCode pestControl";
		assertTrue(!TestLogger.getMessages()
				.containsKey(key));
	}
}
